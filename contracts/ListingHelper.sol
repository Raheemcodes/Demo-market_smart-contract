...
contract ListingHelper {
    event ListCreated(address indexed seller, uint256 tokenId, uint256 price);
    event ListUpdated(address indexed seller, uint256 tokenId, uint256 price);
    event ListPurchased(
    ...
    event ListRemoved(address indexed seller, uint256 tokenId);
