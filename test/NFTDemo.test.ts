import { NFTDemo } from './../typechain-types/contracts/NFTDemo';
...
describe('NFT', () => {
  ...
  let deployContract = async () => {
    ...
    const instance = await NFTDemo.deploy(
      _totalSupply,
      _mintPriceGWei,
      _mintStart,
      _presale,
  ...
  describe('resetMint()', () => {
    ...
    let mint: [bigint, NFTDemo.MintTimeStructOutput, bigint] & {
      priceGWei: bigint;
      time: NFTDemo.MintTimeStructOutput;
      total: bigint;
    };
